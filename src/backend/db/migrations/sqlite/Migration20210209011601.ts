...
export class Migration20210209011601 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table `preprint` (`id` integer not null primary key autoincrement, `uuid` varchar not null, `created_at` datetime not null, `updated_at` datetime not null, `handle` varchar not null, `title` text not null, `authors` text null, `is_published` integer not null, `abstract_text` text null, `preprint_server` varchar null, `date_posted` datetime null, `license` varchar null, `publication` varchar null, `url` varchar null, `content_encoding` varchar null, `content_url` varchar null);');
    this.addSql('create unique index `preprint_uuid_unique` on `preprint` (`uuid`);');
    ...
    this.addSql('create table `persona` (`id` integer not null primary key autoincrement, `uuid` varchar not null, `created_at` datetime not null, `updated_at` datetime not null, `name` varchar not null, `is_anonymous` integer not null, `is_locked` integer not null, `is_flagged` integer not null, `bio` text null, `avatar` blob null, `avatar_encoding` varchar null);');
    this.addSql('create unique index `persona_uuid_unique` on `persona` (`uuid`);');
    ...
    this.addSql('create table `user` (`id` integer not null primary key autoincrement, `uuid` varchar not null, `created_at` datetime not null, `updated_at` datetime not null, `orcid` varchar not null, `is_private` integer not null);');
    this.addSql('create unique index `user_uuid_unique` on `user` (`uuid`);');
    this.addSql('create unique index `user_orcid_unique` on `user` (`orcid`);');

    this.addSql('create table `work` (`id` integer not null primary key autoincrement, `uuid` varchar not null, `created_at` datetime not null, `updated_at` datetime not null, `title` text null, `url` text null, `type` varchar null, `handle` varchar null, `publication_date` datetime null, `publisher` text null);');
    this.addSql('create unique index `work_uuid_unique` on `work` (`uuid`);');

    this.addSql('create table `group` (`id` integer not null primary key autoincrement, `uuid` varchar not null, `created_at` datetime not null, `updated_at` datetime not null, `name` varchar not null);');
    ...
    this.addSql('create table `badge` (`id` integer not null primary key autoincrement, `uuid` varchar not null, `created_at` datetime not null, `updated_at` datetime not null, `name` varchar not null, `color` varchar not null);');
