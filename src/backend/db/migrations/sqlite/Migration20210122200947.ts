...
export class Migration20210122200947 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table `preprint` (`id` integer not null primary key autoincrement, `created_at` datetime not null, `updated_at` datetime not null, `handle` varchar not null, `title` text not null, `authors` text null, `is_published` integer not null, `abstract_text` text null, `preprint_server` varchar null, `date_posted` datetime null, `license` varchar null, `publication` varchar null, `url` varchar null, `content_encoding` varchar null, `content_url` varchar null);');
    ...
    this.addSql('create table `persona` (`id` integer not null primary key autoincrement, `created_at` datetime not null, `updated_at` datetime not null, `name` varchar not null, `is_anonymous` integer not null, `is_locked` integer not null, `is_flagged` integer not null, `bio` text null, `avatar` blob null);');
    this.addSql('create unique index `persona_name_unique` on `persona` (`name`);');

    this.addSql('create table `rapid_review` (`id` integer not null primary key autoincrement, `created_at` datetime not null, `updated_at` datetime not null, `is_published` integer not null, `is_flagged` integer not null, `yn_novel` text check (`yn_novel` in (\'yes\', \'no\', \'N/A\', \'unsure\')) not null, `yn_future` text check (`yn_future` in (\'yes\', \'no\', \'N/A\', \'unsure\')) not null, `yn_reproducibility` text check (`yn_reproducibility` in (\'yes\', \'no\', \'N/A\', \'unsure\')) not null, `yn_methods` text check (`yn_methods` in (\'yes\', \'no\', \'N/A\', \'unsure\')) not null, `yn_coherent` text check (`yn_coherent` in (\'yes\', \'no\', \'N/A\', \'unsure\')) not null, `yn_limitations` text check (`yn_limitations` in (\'yes\', \'no\', \'N/A\', \'unsure\')) not null, `yn_ethics` text check (`yn_ethics` in (\'yes\', \'no\', \'N/A\', \'unsure\')) not null, `yn_new_data` text check (`yn_new_data` in (\'yes\', \'no\', \'N/A\', \'unsure\')) not null, `yn_recommend` text check (`yn_recommend` in (\'yes\', \'no\', \'N/A\', \'unsure\')) not null, `yn_peer_review` text check (`yn_peer_review` in (\'yes\', \'no\', \'N/A\', \'unsure\')) not null, `yn_available_code` text check (`yn_available_code` in (\'yes\', \'no\', \'N/A\', \'unsure\')) not null, `yn_available_data` text check (`yn_available_data` in (\'yes\', \'no\', \'N/A\', \'unsure\')) not null, `link_to_data` text null, `coi` text null);');
    ...
    this.addSql('create table `full_review` (`id` integer not null primary key autoincrement, `created_at` datetime not null, `updated_at` datetime not null, `is_published` integer not null, `is_flagged` integer not null, `doi` varchar null, `coi` text null);');
    ...
    this.addSql('create table `contact` (`id` integer not null primary key autoincrement, `created_at` datetime not null, `updated_at` datetime not null, `schema` varchar not null, `value` varchar not null, `is_verified` integer not null, `send_notifications` integer not null, `token` varchar not null);');
