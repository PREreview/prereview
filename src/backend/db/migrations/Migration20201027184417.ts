...
export class Migration20201027184417 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table `tag` (`id` integer not null primary key autoincrement, `created_at` text not null, `updated_at` text not null, `name` varchar not null, `color` varchar not null);');
    this.addSql('create unique index `tag_name_unique` on `tag` (`name`);');

    this.addSql('create table `preprint` (`id` integer not null primary key autoincrement, `created_at` text not null, `updated_at` text not null, `title` varchar not null, `uuid` varchar not null, `url` varchar not null);');
    ...
    this.addSql('create table `persona` (`id` integer not null primary key autoincrement, `created_at` text not null, `updated_at` text not null, `name` varchar not null, `avatar` blob not null);');
    this.addSql('create unique index `persona_name_unique` on `persona` (`name`);');

    this.addSql('create table `rapid_review` (`id` integer not null primary key autoincrement, `created_at` text not null, `updated_at` text not null, `contents` json not null);');

    this.addSql('create table `request` (`id` integer not null primary key autoincrement, `created_at` text not null, `updated_at` text not null);');

    this.addSql('create table `group` (`id` integer not null primary key autoincrement, `created_at` text not null, `updated_at` text not null, `name` varchar not null);');
    ...
    this.addSql('create table `full_review` (`id` integer not null primary key autoincrement, `created_at` text not null, `updated_at` text not null, `published` text not null, `doi` text not null);');

    this.addSql('create table `full_review_draft` (`id` integer not null primary key autoincrement, `created_at` text not null, `updated_at` text not null, `title` varchar not null, `contents` varchar not null);');
    ...
    this.addSql('create table `community` (`id` integer not null primary key autoincrement, `created_at` text not null, `updated_at` text not null, `name` varchar not null, `description` varchar not null, `logo` blob not null);');
    ...
    this.addSql('create table `comment` (`id` integer not null primary key autoincrement, `created_at` text not null, `updated_at` text not null, `title` varchar not null, `contents` varchar not null);');
