...
export class Migration20201124034734 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table `preprint` (`id` integer not null primary key autoincrement, `created_at` datetime not null, `updated_at` datetime not null, `name` varchar not null, `uuid` varchar null, `doi` varchar null, `arxivid` varchar null, `preprint_server` varchar null, `encoding_format` varchar null, `date_posted` varchar null, `url` varchar not null, `pdf_url` varchar not null);');
