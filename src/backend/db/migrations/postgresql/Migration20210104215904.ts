...
export class Migration20210104215904 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "full_review" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "published" bool not null, "is_flagged" bool not null, "doi" varchar(255) null, "preprint_id" int4 not null);');
