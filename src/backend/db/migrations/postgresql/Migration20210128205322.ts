...
export class Migration20210128205322 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "persona" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "name" varchar(255) not null, "identity_id" int4 null, "is_anonymous" bool not null, "is_locked" bool not null, "is_flagged" bool not null, "bio" text null, "avatar" bytea null);');
    ...
    this.addSql('create table "full_review" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "is_published" bool not null, "is_flagged" bool not null, "doi" varchar(255) null, "preprint_id" int4 not null, "coi" text null);');
