...
<<<<<<< HEAD:src/backend/db/migrations/postgresql/Migration20201222163709.ts
export class Migration20201222163709 extends Migration {
=======
export class Migration20201224045739 extends Migration {
>>>>>>> main:src/backend/db/migrations/postgresql/Migration20201224045739.ts
...
<<<<<<< HEAD:src/backend/db/migrations/postgresql/Migration20201222163709.ts
    this.addSql('create table "persona" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "name" varchar(255) not null, "identity_id" int4 not null, "is_active" bool not null, "avatar" bytea null);');
=======
    this.addSql('create table "persona" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "name" varchar(255) not null, "identity_id" int4 not null, "is_active" jsonb not null, "is_anonymous" jsonb not null, "bio" text null, "avatar" bytea null);');
>>>>>>> main:src/backend/db/migrations/postgresql/Migration20201224045739.ts
    ...
    this.addSql('create table "user" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "orcid" varchar(255) not null, "name" varchar(255) null, "default_persona_id" int4 not null, "is_private" jsonb not null);');
    this.addSql('alter table "user" add constraint "user_default_persona_id_unique" unique ("default_persona_id");');

    this.addSql('create table "work" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "title" varchar(255) null, "author_id" int4 not null, "url" varchar(255) null, "type" varchar(255) null, "handle" varchar(255) null, "publication_date" timestamptz(0) null, "publisher" varchar(255) null);');
    ...
    this.addSql('create table "contact" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "schema" varchar(255) not null, "value" varchar(255) not null, "identity_id" int4 not null, "is_verified" jsonb not null);');
    ...
    this.addSql('alter table "user" add constraint "user_default_persona_id_foreign" foreign key ("default_persona_id") references "persona" ("id") on update cascade;');
