...
export class Migration20210129004412 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "full_review" ("id" serial primary key, "uuid" varchar(255) not null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "is_published" bool not null, "is_flagged" bool not null, "doi" varchar(255) null, "preprint_id" int4 not null, "coi" text null);');
    ...
    this.addSql('create table "full_review_invitees" ("full_review_id" int4 not null, "persona_id" int4 not null);');
    this.addSql('alter table "full_review_invitees" add constraint "full_review_invitees_pkey" primary key ("full_review_id", "persona_id");');
    ...
    this.addSql('create table "contact" ("id" serial primary key, "uuid" varchar(255) not null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "schema" varchar(255) not null, "value" varchar(255) not null, "identity_id" int4 not null, "is_verified" bool not null, "send_notifications" bool not null, "token" varchar(255) null);');
    this.addSql('alter table "contact" add constraint "contact_uuid_unique" unique ("uuid");');

    this.addSql('create table "community" ("id" serial primary key, "uuid" varchar(255) not null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "name" varchar(255) not null, "description" text null, "logo" bytea null);');
    ...
    this.addSql('alter table "full_review_invitees" add constraint "full_review_invitees_full_review_id_foreign" foreign key ("full_review_id") references "full_review" ("id") on update cascade on delete cascade;');
    this.addSql('alter table "full_review_invitees" add constraint "full_review_invitees_persona_id_foreign" foreign key ("persona_id") references "persona" ("id") on update cascade on delete cascade;');
