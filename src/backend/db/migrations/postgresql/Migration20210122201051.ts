...
export class Migration20210122201051 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "contact" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "schema" varchar(255) not null, "value" varchar(255) not null, "identity_id" int4 not null, "is_verified" bool not null, "send_notifications" bool not null, "token" varchar(255) not null);');
